...
map.getView().fit([615853.110325, 1282250.187969, 640498.958715, 1298774.749933], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">MAP OF MEENANGADY PANCHAYAT</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (132 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'THIS IS THE MAP OF MEENANGADY GRAMA PANCHAYAT.WHICH DEPICTS THE BASIC DATA ABOUT GEOMORPHOLOGY, DRAINAGE, ROAD, AND MAJOR JUNCTIONS.';
            }
